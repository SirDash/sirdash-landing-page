...
const VerifyEmail = () => {
  ...
  useEffect(() => {
    const verifyEmail = async () => {
      const result = await handleEmailVerification(token_hash, type);
      if (result.success) {
        setVerificationStatus("success");
        setMessage("Your email has been successfully verified! You can now log in to your account.");
      } else {
        setVerificationStatus("error");
        setMessage(result.errorMessage ?? "There was a problem verifying your email. The link may have expired or is invalid.");
      }
    };
